...
enum ThemeXMLGenerator {
    ...
    static func generateSlideMasterXML(theme: Theme, layoutCount: Int = 1) -> String {
        ...
        for i in 1...layoutCount {
            layoutRels += "    <p:sldLayoutId id=\"\(2147483649 + i)\" r:id=\"rId\(i)\"/>\n"
        }
    ...
    static func generateSlideMasterRels(layoutCount: Int = 1, themeRId: String = "rId100") -> String {
        var rels = ""
        for i in 1...layoutCount {
            rels += "  <Relationship Id=\"rId\(i)\" Type=\"\(OOXML.relTypeSlideLayout)\" Target=\"../slideLayouts/slideLayout\(i).xml\"/>\n"
        }
        rels += "  <Relationship Id=\"\(themeRId)\" Type=\"\(OOXML.relTypeTheme)\" Target=\"../theme/theme1.xml\"/>\n"
